...
const Header = () => {
  ...
  const [isSettingRefActive,setIsSettingRefActive]=useDetectOutsideClick(settingRef,false);
            ...
            <ul className="header-nav">
              ...
              <li className="header-nav-item"
                onClick={()=>{
                  setIsMessageActive(false);
                  setIsNotificationActive(false);
                  setIsSettingRefActive(!isSettingRefActive);
                }}>
